<h2><a href="https://www.geeksforgeeks.org/problems/power-of-2-1587115620/1?page=2&difficulty=Easy&sortBy=submissions">Power of 2</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a non-negative integer <strong>n</strong>, return true if it is a power of <strong>2</strong>.&nbsp;Otherwise, return false.&nbsp;&nbsp;<br></span></p>
